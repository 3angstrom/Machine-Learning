...
class SLR(object):
    ...
    """
    # to initialize or assign some starting values.	
    ...
    # to make our own printable representation of an object, output is the address of the object in memory
    def __repr__(self):
        params = {
    ...
    #predicts the probability value for each row
    ...
    #  to make discrete predictions. It  compares probability values against a cutoff. Probability values below the cutoff belong to one class, and those greater than or equal to the cutoff belong to another class.
    def predict(self, X):
    ...
    # calculate the accuracy score, compare discrete prediction values against the actual.
    def score(self, X, y):
        """
        The score method
        Param
    ...
    # implements stochastic gradient descent to update the w and b parameters.
    def fit(self, X, y):
        """
